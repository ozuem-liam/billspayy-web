...
const SERVICE_ID_NAMES: Record<string, string> = {
  ...
  D06D: 'NTEL',
  // Electricity
  E01E: 'Ikeja Electric (IKEDC) — Prepaid',
  E02E: 'Ikeja Electric (IKEDC) — Postpaid',
  E03E: 'Ibadan Electric (IBEDC) — Prepaid',
  E04E: 'Ibadan Electric (IBEDC) — Postpaid',
  E05E: 'Eko Electric (EKEDC) — Prepaid',
  E06E: 'Eko Electric (EKEDC) — Postpaid',
  E07E: 'Abuja Electric (AEDC) — Prepaid',
  E08E: 'Abuja Electric (AEDC) — Postpaid',
  E09E: 'Port Harcourt Electric (PHED) — Prepaid',
  E10E: 'Port Harcourt Electric (PHED) — Postpaid',
  E11E: 'Kaduna Electric (KAEDCO) — Prepaid',
  E12E: 'Kaduna Electric (KAEDCO) — Postpaid',
  E13E: 'Jos Electric (JED) — Prepaid',
  E14E: 'Jos Electric (JED) — Postpaid',
  E15E: 'Enugu Electric (EEDC) — Prepaid',
  E16E: 'Enugu Electric (EEDC) — Postpaid',
  E17E: 'Kano Electric (KEDC) — Prepaid',
  E18E: 'Kano Electric (KEDC) — Postpaid',
  // Cable TV
  DSTV: 'DStv',
  GOTV: 'GOtv',
  STARTIMES: 'StarTimes',
